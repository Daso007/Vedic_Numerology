...
if st.button("✨ Generate My Complete Numerology Report ✨"):
    ...
    # Disclaimer Section
st.subheader("⚠️ Important Disclaimer ⚠️")
st.warning(
    """
    This application is for **informational, entertainment, and self-discovery purposes only.** 
    It is not intended to be a substitute for professional advice (e.g., medical, psychological, financial, legal, or career counseling). 
    Numerology is a metaphysical system, and its interpretations are based on historical and traditional beliefs, not scientific fact.
    
    All interpretations provided by this application are generated by an Artificial Intelligence model based on specific numerology texts. 
    While every effort is made to accurately reflect the source material, the output should be considered an AI-generated reading and used for personal reflection only.
    
    **The creator of this application is not responsible for any decisions made based on the information provided herein. Users should always consult qualified professionals for advice on any personal or professional matters.**
    """
)
...
st.write(
    ...
    -   **Your Name:** Dibyajyoti Datta
    -   **Email ID:** dattadibyajyoti014@gmail.com
    """
)